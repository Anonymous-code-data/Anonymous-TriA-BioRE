...
def main():
    ...
    parser.add_argument("--save_path", default="saved_models/PubMedBERT/TriA-BioRE.pt", type=str)
    # parser.add_argument("--load_path", default="saved_models/PubMedBERT/TriA-BioRE.pt", type=str)
